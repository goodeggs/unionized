 ...
 */
var FactoryDefinition, Unionized, dot, dotSubPaths, factoryFunctions, fn, _, _fn, _i, _len,
...
FactoryDefinition = (function() {
  ...
  FactoryDefinition.prototype.setAttrs = function() {
    var init, key, value, _ref, _results;
    init = true;
    _ref = this.attrs;
    _results = [];
    for (key in _ref) {
      value = _ref[key];
      if (value !== void 0) {
        _results.push(dot.set(this._out, key, value, init));
      } else {
  ...
  FactoryDefinition.prototype.unset = function(key) {
    var init;
    init = false;
    return dot.set(this._out, key, void 0, init);
  };
